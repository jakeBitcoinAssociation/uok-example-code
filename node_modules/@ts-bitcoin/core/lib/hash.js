...
class Hash {
    static sha1(buf) {
        ...
        const hash = hash_js_1.sha1().update(buf).digest();
    ...
    static sha256(buf) {
        ...
        const hash = hash_js_1.sha256().update(buf).digest();
        return Buffer.from(hash);
    }
    ...
    static ripemd160(buf) {
        ...
        const hash = hash_js_1.ripemd160().update(buf).digest();
        return Buffer.from(hash);
    }
    ...
    static sha512(buf) {
        ...
        const hash = hash_js_1.sha512().update(buf).digest();
        return Buffer.from(hash);
    }
