...
class SigOperations extends struct_1.Struct {
     ...
     */
    setOne(txHashBuf, txOutNum, nScriptChunk, type = 'sig', addressStr, nHashType = sig_1.Sig.SIGHASH_ALL | sig_1.Sig.SIGHASH_FORKID) {
    ...
    addOne(txHashBuf, txOutNum, nScriptChunk, type = 'sig', addressStr, nHashType = sig_1.Sig.SIGHASH_ALL | sig_1.Sig.SIGHASH_FORKID) {
